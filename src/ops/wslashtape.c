...
I2C_GET_8(op_WS_T_RECORD_get, WS_ADDR, WS_T_RECORD)
I2C_GET_8(op_WS_T_PLAY_get, WS_ADDR, WS_T_PLAY)
I2C_GET_0(op_WS_T_REV_get, WS_ADDR, WS_T_REV)
I2C_GET_16_16(op_WS_T_SPEED_get, WS_ADDR, WS_T_SPEED)
I2C_GET_16(op_WS_T_FREQ_get, WS_ADDR, WS_T_FREQ)
I2C_GET_16(op_WS_T_PRE_LEVEL_get, WS_ADDR, WS_T_PRE_LEVEL)
I2C_GET_16(op_WS_T_MONITOR_LEVEL_get, WS_ADDR, WS_T_MONITOR_LEVEL)
I2C_GET_16(op_WS_T_REC_LEVEL_get, WS_ADDR, WS_T_REC_LEVEL)
I2C_GET_8(op_WS_T_HEAD_ORDER_get, WS_ADDR, WS_T_HEAD_ORDER)
I2C_GET_0(op_WS_T_LOOP_START_get, WS_ADDR, WS_T_LOOP_START)
I2C_GET_0(op_WS_T_LOOP_END_get, WS_ADDR, WS_T_LOOP_END)
I2C_GET_8(op_WS_T_LOOP_ACTIVE_get, WS_ADDR, WS_T_LOOP_ACTIVE)
I2C_GET_8(op_WS_T_LOOP_SCALE_get, WS_ADDR, WS_T_LOOP_SCALE)
I2C_GET_8(op_WS_T_LOOP_NEXT_get, WS_ADDR, WS_T_LOOP_NEXT)
I2C_GET_16_16(op_WS_T_TIMESTAMP_get, WS_ADDR, WS_T_TIMESTAMP)
I2C_GET_16_16(op_WS_T_SEEK_get, WS_ADDR, WS_T_SEEK)
